...
//
//Purpose:  This is the page that is first
//		 	presented to the user when they try to login
//
...
if (isset($_POST["submit"])) {
	...
	/*if (!$aVar->getErrName() && !$aVar->getErrEmail() && !$aVar->getErrMessage() && !$aVar->getErrHuman()) {
		...
		header("http://rrespino.com/TestGolf.php"); /* Redirect browser */
		exit();
	}
}
else{}
